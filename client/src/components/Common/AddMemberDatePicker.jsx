...
const AddMemberDatePicker = ({ value, onChange, name }) => {
      ...
      <div className="flex items-center gap-2 mb-2">
        <div className="flex-1 relative">
          <Input
            ...
            readOnly
            className="w-full pl-10 bg-white border-gray-200 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-30 rounded-md"
          />
...
export default AddMemberDatePicker; 